	...
	<div class="portlet light bordered">
		...
		<div class="portlet-body form">
			...
			<form action="{{url('admin/save-order')}}" class="form-horizontal" method="POST">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<input type="text" class="form-control" placeholder="Enter ..." id="service_cus_name" name="service_cus_name" value="{{$order->service_cus_name}}">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<input type="email" class="form-control" placeholder="Enter ..." id="service_cus_email" name="service_cus_email" value="{{$order->service_cus_email}}">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<div class="input-group date">
										...
										<input type="text" class="form-control pull-right dpicker" id="service_crete_date" name="service_crete_date" value="{{ Carbon\Carbon::parse($order->service_crete_date)->format('d/m/Y') }}">
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-md-8">
									<input type="text" class="form-control" placeholder="Enter ..." id="cell_number" name="cell_number" value="{{$order->cell_number}}">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8">
									<div class="input-group date">
										...
										<input type="text" class="form-control pull-right dpicker" name="service_delivery_date" id="service_delivery_date" value="{{Carbon\Carbon::parse($order->service_delivery_date)->format('d/m/Y') }}">
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								...
								<div class="col-md-10">
									<textarea class="form-control" rows="3" placeholder="Enter ..." id="service_cus_address" name="service_cus_address">{{$order->service_cus_address}}</textarea>
								</div>
							</div>
							</div>
						</div>
				...
				<div class="row pading-margin-zero">
					<input name="orderdetail_id[]" type="hidden" value="{{$orderdetail->id}}">
					<div class="col-md-3">
						<div class="form-group">
							<div class="col-md-11">
								<select class="form-control service_id" name="service_id[]" id="service_id">
									...
									@foreach($services as $service)
										@if($service->id==$orderdetail->service_id)
					...
					<div class="col-md-2">
						...
						<div class="form-group">
							<div class="col-md-10">
								<input type="text" class="form-control service_price" placeholder="Service Rate" name="service_price[]" id="service_price" value="{{$orderdetail->service_price}}" readonly>
					...
					<div class="col-md-2">
						<div class="form-group">
							<div class="col-md-10">
								<input type="text" class="form-control service_qty" placeholder="Quantity.." id="service_qty" name="service_quantity[]" value="{{$orderdetail->service_quantity}}">
							</div>
						</div>
					</div>
					<div class="col-md-2" >
						<div class="form-group">
							<div class="form-group">
								<div class="col-md-10" >
									<input type="text" class="form-control amount" placeholder="Service Amount" id="amount" name="service_amount[]" value="{{$orderdetail->service_amount}}" readonly>
								</div>
							</div>
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<div class="col-md-10" >
								<button type="button" class="btn red btn-block removeService" id="removeService" disabled="disabled"> Delete</button>
							</div>
						</div>
					</div>
				</div>
						<div class="row pading-margin-zero">
							<div class="col-md-12 col-md-offset-1">
								<div class="form-group">
									<div class="col-md-10" >
										<textarea type="text" class="form-control" placeholder="Enter Measurement of Service ..." name="service_measer[]">{{$orderdetail->service_measer}}</textarea>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-3">
							<div class="input-group">
								...
								<!-- /btn-group -->
								<input type="text" class="form-control" id="total" name="total_amount" value="{{$order->total_amount}}" style="font-size:25px; font-weight: bold" readonly>
							</div>
						</div>
						<div class="col-md-3">
							<div class="input-group">
								...
								<input type="text" class="form-control" id="discount" name="discount_amount" value="{{$order->discount_amount}}" style="font-size:25px;  font-weight: bold">
							</div>
						</div>
						<div class="col-md-3">
							<div class="input-group">
								...
								@php
									$payment = App\Order::find($order->id)->payments->first();

									if($payment==''){
										$adv_amount = 0;
									}else{
									$adv_amount = $payment->received_amount;
								}
								@endphp
								<input type="text" class="form-control" id="advance_amount" name="advance_amount" value="{{$adv_amount}}" style="font-size:15px;  font-weight: bold">							</div>
						</div>
						<div class="col-md-3">
        ...
        if (serviceRowQty == 1){
          ...
          return false;
    		...
    		$(".serviceRow").delegate('.service_qty', "keyup",function(){
       		...
       		$('.serviceRow').delegate('.service_id,#discount','change',function(){
       		    //alert('selectButton');
       		var subdiv = $(this).parent().parent().parent().parent();
