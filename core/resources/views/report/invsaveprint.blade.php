...
<body>
  ...
  <div class="headerinv">
      ...
      <div class="headerright">
          <img src="{{URL::asset('/assets/images/logo/logo.png')}}" height="100" width="100">
      </div>
  </div>
  <div class="cus-info">
      ...
      <table class="table table-hover table-striped table-condensed">
        <thead>
            <tr class="firsttr">
                <th>#</th>
                <th>SERVICE NAME</th>
                <th class="alingcenter">UNIT PRICE({{$sinfo->currency_text}})</th>
        ...
        @foreach($order->orderdetails as $orderdetial)
            ...
            <tr>
                ...
                <td class="alingright">{{$sinfo->currency_text}} {{number_format($orderdetial->service_amount,2)}}</td>
            </tr> 
        @endforeach   
        </tbody>
            <tfoot>
                <tr>
                    ...
                    <th></th>
                     <th></th>
                    <th>Sub Total:</th>
                    <th class="alingright"><b> {{$sinfo->currency_text}} </b> {{number_format(($order->total_amount + $order->discount_amount),2)}}</th> 
                  </tr>
                  <tr>
                    <th></th>
                    <th></th>
                    ...
                    <th class="lasttr alingright"> <b> {{$sinfo->currency_text}} </b> -{{number_format($order->discount_amount,2)}}</th>
                  </tr>
                  <tr>
                    <th></th>
                    <th></th>
                    ...
                    <th class="lasttr alingright"><span class="sub-total"><b> {{$sinfo->currency_text}} </b>  {{number_format($order->total_amount,2)}}  </span></th>                      
                </tr>
                <tr>
                    <th></th>
                    <th></th>
                    ...
                    <th class="lasttr alingright"><b> {{$sinfo->currency_text}} </b> -{{number_format($order->payments->sum('received_amount'),2)}}</th> 
                  </tr>
                <tr>
                    <th></th>
                    <th></th>
                    ...
                    <th class="lasttr alingright"><b> {{$sinfo->currency_text}} </b> -{{number_format($order->payments->sum('add_discount_amount'),2)}}</th>
                </tr>
                  <tr>
                    <th></th>
                    <th></th>
                    ...
                    <th class="lasttr alingright"><b> {{$sinfo->currency_text}} </b> {{number_format($order->total_amount-$order->payments->sum('received_amount'),2)}}</th> 
                  </tr>
            </tfoot>                         
    </table>
